...
void __attribute__((picinterrupt(("")))) isr (void){
     ...
     if (RCIF){
        ...
        if (RCREG == '1'){
            ...
            USART_print(bufferTemp);
        }
        else if (RCREG == '3'){
           USART_print(bufferHum);
        }

        else if (RCREG == '4'){
           USART_print(bufferAlarm);
           bufferAlarm = "0";
        ...
        if (ala_hour == hour){
            if (ala_min == min){
                ...
                if (HumidityValue<= 69){
                    ...
                    _delay((unsigned long)((2900)*(8000000/4000.0)));
                }else {
                    _delay((unsigned long)((3600)*(8000000/4000.0)));
                }
                PORTA = 0;
                }
            }
